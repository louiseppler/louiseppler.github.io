...
function textFieldOnChange(id) {
    ...
    stations.forEach(station => {
        station.stop_name = station.stop_name.toLowerCase();
    });


    stations.forEach(station => station.priority = prioritiseStation(input, station.stop_name));
    ...
    var possibleStations = stations.filter(x => x.stop_name.includes(input));
